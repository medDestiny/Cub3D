...
/*   Updated: 2023/11/24 10:22:01 by mmisskin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_data *data)
{
	...
	if (data->player->move.back == 1)
		initiate_move(data->player, data->map, fix_angle(data->player->angle + M_PI));
	if (data->player->move.left == 1)
		initiate_move(data->player, data->map, fix_angle(data->player->angle - M_PI / 2));
